...
一个自托管的网页仪表盘，用于追踪以人民币为中心的汇率数据，支持交互式图表、AI 智能分析，以及英文、简体中文、繁体中文三语界面。

## 功能特性

- **19 个货币对**每日追踪 —— 英镑/欧元/美元/以色列谢克尔兑人民币、多组交叉汇率、人民币兑日元/韩元/新台币/印度卢比/卢布/港币/乌克兰格里夫纳，以及比特币交叉对
- **交互式图表**，带最大/最小值标签、十字准线提示、各图表百分比涨跌、分组最高/最低高亮、合并视图悬停发光效果和拖拽排序
- **两种显示模式** —— 分离视图（19 张独立图表）或合并视图（3 张多线图表）
- **灵活的时间范围** —— 滚动窗口（7天/1个月/3个月/6个月/1年）、日历锚定（本/上周/月/年）或全部数据
- **列数布局切换** —— 1、2、3 或 4 列
- **导出功能** —— 单独导出各图表 PNG 或合并为一张图片，均包含图表标题
...
**分离视图** —— 以网格形式展示 19 张独立图表，每张追踪一个货币对。右侧 AI 对话侧边栏已展开，显示波动分析摘要，包含最小值/最大值/区间汇总表及主要发现。
...
| 分组 | 货币对 |
|---|---|
| 人民币兑入 | 英镑、欧元、美元、以色列谢克尔 -> 人民币 |
| 人民币兑出 | 人民币 -> 日元、韩元、新台币、印度卢比、卢布、港币、乌克兰格里夫纳 |
| 西方货币交叉汇率 | 英镑 -> 欧元、英镑 -> 美元、欧元 -> 美元、美元 -> 日元、美元 -> 新台币 |
| 加密货币 | BTC -> 美元、人民币、欧元 |
